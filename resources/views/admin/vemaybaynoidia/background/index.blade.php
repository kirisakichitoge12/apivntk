...
<div class="container mt-5">
    <h1>Quản lý Background - Vé máy bay nội địa</h1>
    ...
    <form action="{{ route('vemaybaynoidia.background.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
        <div class="mb-3">
    ...
    @if ($background)
        ...
        <form action="{{ route('vemaybaynoidia.background.destroy', $background->id) }}" method="POST"
