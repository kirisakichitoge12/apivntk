...
<div class="container mt-5">
    ...
    <form action="{{ route('khuyenmai.banners.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
        <div class="mb-3">
    ...
    <table class="table table-bordered">
        ...
        @forelse ($banners as $banner)
            <tr>
                ...
                <td>
                    <form action="{{ route('khuyenmai.banners.destroy', $banner->id) }}" method="POST"
