...
<div class="container mt-5">
    <h1>Quản lý Background - Khuyến mãi</h1>
    ...
    <form action="{{ route('khuyenmai.background.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
        <div class="mb-3">
    ...
    @if ($background)
        ...
        <form action="{{ route('khuyenmai.background.destroy', $background->id) }}" method="POST"
