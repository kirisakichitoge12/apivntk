...
<div class="container mt-5">
    <h1>Quản lý Banner - Vé máy bay quốc tế</h1>
    ...
    <form action="{{ route('vemaybayquocte.banners.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
        <div class="mb-3">
    ...
    <table class="table table-bordered">
        ...
        @forelse ($banners as $banner)
            <tr>
                ...
                <td>
                    <form action="{{ route('vemaybayquocte.banners.destroy', $banner->id) }}" method="POST"
